...
namespace Lapshop.Migrations
{
    ...
    [Migration("20230124185846_CreateComparisionTable")]
    partial class CreateComparisionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lapshop.Models.Comparsion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FirstAccessoryId")
                        .HasColumnType("int");

                    b.Property<int?>("FirstLaptopId")
                        .HasColumnType("int");

                    b.Property<int?>("SecondAccessoryId")
                        .HasColumnType("int");

                    b.Property<int?>("SecondLaptopId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("FirstAccessoryId");

                    b.HasIndex("FirstLaptopId");

                    b.HasIndex("SecondAccessoryId");

                    b.HasIndex("SecondLaptopId");
            ...
            modelBuilder.Entity("Lapshop.Models.Comparsion", b =>
                {
                    b.HasOne("Lapshop.Models.Accessory", "FirstAccessory")
                        .WithMany()
                        .HasForeignKey("FirstAccessoryId");

                    b.HasOne("Lapshop.Models.Laptop", "FirstLaptop")
                        .WithMany()
                        .HasForeignKey("FirstLaptopId");

                    b.HasOne("Lapshop.Models.Accessory", "SecondAccessory")
                        .WithMany()
                        .HasForeignKey("SecondAccessoryId");

                    b.HasOne("Lapshop.Models.Laptop", "SecondLaptop")
                        .WithMany()
                        .HasForeignKey("SecondLaptopId");

                    b.Navigation("FirstAccessory");

                    b.Navigation("FirstLaptop");

                    b.Navigation("SecondAccessory");

                    b.Navigation("SecondLaptop");
                });
